...
const UserFilterCardForDm = ({
	...
	var isCollapsed: boolean = selectedDynamicMeasureProps.chartAxes[0].isCollapsed;
...
const mapDispatchToProps = (dispatch: Dispatch<any>) => {
	return {
		...
		revertAxesForDm: (propKey: string, bIndex: number, uId: any, originalIndex: any) =>
			dispatch(revertAxesForDm(propKey, bIndex, uId, originalIndex)),
		updtateFilterExpandeCollapseForDm: (propKey: string, bIndex: number, item: any) =>
...
export default connect(mapStateToProps, mapDispatchToProps)(UserFilterCardForDm);
